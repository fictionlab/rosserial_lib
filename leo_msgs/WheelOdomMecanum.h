#ifndef _ROS_leo_msgs_WheelOdomMecanum_h
#define _ROS_leo_msgs_WheelOdomMecanum_h
...
namespace leo_msgs
{
  ...
  class WheelOdomMecanum : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "leo_msgs/WheelOdomMecanum"; };
